<template>
    <swiper :slidesPerView="slidesPerView" :spaceBetween="10" :navigation="false" :scrollbar="true" :autoplay="true" :modules="modules"
        class="mySwiper">
        <swiper-slide v-for="sponsor in sponsors" :key="sponsor.id" class="swiper-slider">
